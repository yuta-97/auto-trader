...
import {
  ...
  RsiBollinger,
  GridTrading,
} from "../strategies/refactored";
import path from "path";
import { MARKETS, CANDLE_INTERVAL } from "../strategies/constants";

async function testRefactoredStrategies() {
  console.log("=== 리팩토링된 전략 백테스트 시작 ===\n");
...
if (require.main === module) {
  testRefactoredStrategies().catch(console.error);
}

export { testRefactoredStrategies };
